...
namespace DataAccessLayer
{
    public class DBConnection
    {
        ...
        public static int ProcessAttendance(string pYYYYMM, string pCrBy)
        {
            OracleConnection connection = null;
            try
            {
                ...
                OracleCommand cmd = new OracleCommand();
                cmd.Connection = connection;
                cmd.CommandText = "DPRC_PROCEESS_EMP_ATTENDANCE";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("P_YYYYMM", OracleType.VarChar).Value = pYYYYMM;
                cmd.Parameters.Add("P_CR_BY", OracleType.VarChar).Value = pCrBy;
                cmd.Parameters.Add("P_STATUS", OracleType.Double).Direction = ParameterDirection.Output;
                cmd.ExecuteNonQuery();
        ...
        public static int ProcessPayroll(string pYYYYMM, string pCrBy)
        {
            OracleConnection connection = null;
            try
            {
