<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Transaction.Master" AutoEventWireup="true" CodeBehind="SlipGeneration.aspx.cs" Inherits="HR_PAYROLL_PROCESSING_SYSTEM.Transaction.SlipGeneration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="outer-container-master">
        <div class="mb-3 container">
            ...
            <asp:GridView runat="server" ID="grid1" AutoGenerateColumns="False" DataKeyNames="PR_EMP_NO,PR_YYYMM" OnRowEditing="grid1_RowEditing" CssClass="grid-view" Width="100%" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found">
                <Columns>
