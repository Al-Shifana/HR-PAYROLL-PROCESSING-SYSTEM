...
<head runat="server">
    ...
    <style>
        body {
               ...
               background-image: url('../Images/pexels-fauxels-3183165.jpg'); /* Relative path to the image */
    ...
    <form id="form1" runat="server">
        ...
        <div class="login-container">
            ...
            <div>
                ...
                <asp:Label runat="server" ID="lblMessage" CssClass="form-label" ForeColor="Red"></asp:Label>
            </div>
